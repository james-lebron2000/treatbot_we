...
if [ -f "${REMOTE_OCR_SECRET_FILE:-}" ]; then
  ...
  for SECRET_KEY_NAME in KIMI_API_KEY ARK_API_KEY DOUBAO_API_KEY DOUBAO_BASE_URL DOUBAO_MODEL ARK_TEXT_MODEL DOUBAO_TEXT_MODEL OCR_STRUCTURED_MODEL OCR_STRUCTURED_FAST_MODEL OCR_STRUCTURED_FAST_MODEL_RATIO VOLCENGINE_AK VOLCENGINE_SK; do
