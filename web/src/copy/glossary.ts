// Re-export of shared/copy/glossary.js for web consumers.
// Source of truth migrated from .json → .js because WeApp `require()` cannot
// resolve `.json` extensions. Single source of truth still lives at
// shared/copy/glossary.js so it can be reused by 小程序 / web / docs. Keep this
// file as a thin re-export only.
//
...
import glossary from '../../../shared/copy/glossary.js'
