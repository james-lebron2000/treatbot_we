...
- **Run**: 25248965072
- **Commit**: `98fb89e7c196672bc300e3b56c77a7c089283179`
- **Workflow URL**: https://github.com/james-lebron2000/treatbot_we/actions/runs/25248965072
- **Generated at**: 2026-05-02T10:00:32Z

---

```
===== Deploy 20260502-030455 — SHA=b586c9d36899e88c0cc8a080fb2a3396823c36a6 =====
::group::A) Backend container replace
  ✓ tarball size: 230 MB
Loaded image: treatbot-api:b586c9d36899e88c0cc8a080fb2a3396823c36a6
  ✓ Image treatbot-api:b586c9d36899e88c0cc8a080fb2a3396823c36a6 loaded into local daemon
  ✓ Old image 'treatbot-api:6bb2681f3f7de01e843e0165412e8b4ff36b5ecb' backed up as treatbot-api:rollback-20260502-030455
  ✓ Old env backed up to /home/ubuntu/treatbot-deploy-backups/treatbot-api.20260502-030455.env (44 vars)
treatbot-api
  Cleaning old prev containers:
treatbot-api-prev-20260430-095800
  ✓ Old container renamed to treatbot-api-prev-20260502-030455
  OCR env override:
...
7e7f2be8fa8ef6fabe3b21c7bca5e4cee09163051794de1da0f557a4db658400
  ✓ Healthy after 3s
  ✅ Backend deployed. Rollback cmd:
     docker stop treatbot-api && docker rm treatbot-api && docker rename treatbot-api-prev-20260502-030455 treatbot-api && docker start treatbot-api
::endgroup::
...
::group::B) Web frontend promote
  ...
  ✓ Web backed up to /home/ubuntu/treatbot-deploy-backups/web.20260502-030455
...
unknown
  ...
  ===== 2. Listening sockets (top relevant ports) =====
    ...
    LISTEN 0      4096         0.0.0.0:3000      0.0.0.0:*    users:(("docker-proxy",pid=3534658,fd=4))               
    ...
    LISTEN 0      4096            [::]:3000         [::]:*    users:(("docker-proxy",pid=3534666,fd=4))               
  ===== 3. Docker containers + ports =====
    NAMES            IMAGE                                                   PORTS                                                  STATUS
    treatbot-api     treatbot-api:b586c9d36899e88c0cc8a080fb2a3396823c36a6   0.0.0.0:3000->3000/tcp, :::3000->3000/tcp              Up 7 seconds (healthy)
  ...
  ===== 10. /var/www listing =====
    ...
    drwxr-xr-x  3 ubuntu ubuntu 4096 May  2 02:55 treatbot-web
  ===== 11. Backup nginx tree (NOT removing) =====
    ✓ nginx tree → /home/ubuntu/treatbot-deploy-backups/nginx-tree.20260502-030455.tar.gz (16K)
  ===== 12. Backup current Caddyfile =====
    ✓ Caddyfile → /home/ubuntu/treatbot-deploy-backups/Caddyfile.20260502-030455
::group::C.5) Apply new Caddyfile + retire nginx
  ✓ New Caddyfile uploaded (114 lines)
  ✓ Current Caddyfile backed up to /home/ubuntu/treatbot-deploy-backups/Caddyfile.before-swap.20260502-030455
  --- diff (current → new) ---
  --- end diff ---
  --- validate (rc=0) ---
    {"level":"info","ts":1777662327.5195866,"msg":"using config from file","file":"/tmp/deploy/Caddyfile"}
    {"level":"warn","ts":1777662327.5295842,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5296092,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5299206,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5299323,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5300224,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5300398,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5301564,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777662327.5301673,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"info","ts":1777662327.5311384,"msg":"adapted config to JSON","adapter":"caddyfile"}
    {"level":"warn","ts":1777662327.531151,"msg":"Caddyfile input is not formatted; run 'caddy fmt --overwrite' to fix inconsistencies","adapter":"caddyfile","file":"/tmp/deploy/Caddyfile","line":23}
    {"level":"info","ts":1777662327.5318818,"logger":"tls.cache.maintenance","msg":"started background certificate maintenance","cache":"0xc000560700"}
    {"level":"info","ts":1777662327.5330029,"logger":"http.auto_https","msg":"skipping automatic certificate management because one or more matching certificates are already loaded","domain":"inseq.top","server_name":"srv0"}
    {"level":"info","ts":1777662327.5330162,"logger":"http.auto_https","msg":"skipping automatic certificate management because one or more matching certificates are already loaded","domain":"www.inseq.top","server_name":"srv0"}
    {"level":"info","ts":1777662327.5330195,"logger":"http.auto_https","msg":"enabling automatic HTTP->HTTPS redirects","server_name":"srv0"}
    {"level":"info","ts":1777662327.5343175,"logger":"tls.cache.maintenance","msg":"stopped background certificate maintenance","cache":"0xc000560700"}
    Valid configuration
  --- end validate ---
...
unknown enabled=disabled
unknown
  ✓ nginx tree archived → /home/ubuntu/treatbot-deploy-backups/nginx-tree.retired.20260502-030455.tar.gz
  ✓ nginx already disabled
::endgroup::
::group::D) Smoke tests
  /health (container):
{"status":"ok","timestamp":"2026-05-01T19:05:30.739Z","version":"1.0.0","environment":"production"}
  / (via nginx):
    HTTP 200
