...
- **Run**: 25227089048
- **Commit**: `6bb2681f3f7de01e843e0165412e8b4ff36b5ecb`
- **Workflow URL**: https://github.com/james-lebron2000/treatbot_we/actions/runs/25227089048
- **Generated at**: 2026-05-01T18:28:01Z

---

```
===== Deploy 20260502-022731 — SHA=6bb2681f3f7de01e843e0165412e8b4ff36b5ecb =====
::group::A) Backend container replace
6bb2681f3f7de01e843e0165412e8b4ff36b5ecb: Pulling from jakelebron18/treatbot-api
Digest: sha256:1ec9693b4b310056eaf7d832b0d6917ad7bf470bf20b0a50c236f514c9b8547f
Status: Downloaded newer image for jakelebron18/treatbot-api:6bb2681f3f7de01e843e0165412e8b4ff36b5ecb
docker.io/jakelebron18/treatbot-api:6bb2681f3f7de01e843e0165412e8b4ff36b5ecb
  ✓ docker pull 成功 (attempt 1/3)
  ✓ Old image 'treatbot-api:1a0055f3f734d814eac8557db5738cefa2091f8a' backed up as treatbot-api:rollback-20260502-022731
  ✓ Old env backed up to /home/ubuntu/treatbot-deploy-backups/treatbot-api.20260502-022731.env (39 vars)
treatbot-api
  Cleaning old prev containers:
treatbot-api-prev-20260430-011322
  ✓ Old container renamed to treatbot-api-prev-20260502-022731
  OCR env override:
    ⚠ MINIMAX_API_KEY: 未设置 → 沿用旧 env
    ⚠ MINIMAX_VISION_MODEL: 未设置（图像 OCR 会跳到 Kimi vision）
    ✓ KIMI_API_KEY (len=51)
    ✓ ARK_API_KEY (len=46)
    ✓ ARK_VISION_MODEL=doubao-seed-1-6-vision-250815
    ✓ ARK_BASE_URL=https://ark.cn-beijing.volces.com/api/v3
    ✓ ARK_TIMEOUT_MS=180000
96edb1e18415475fa6aa782a283255f4f2450296f1d002b8febabff386dc4d83
  ✓ Healthy after 3s
  ✅ Backend deployed. Rollback cmd:
     docker stop treatbot-api && docker rm treatbot-api && docker rename treatbot-api-prev-20260502-022731 treatbot-api && docker start treatbot-api
::endgroup::
...
::group::B) Web frontend promote
  ...
  ✓ Web backed up to /home/ubuntu/treatbot-deploy-backups/web.20260502-022731
...
unknown
  ...
  ===== 2. Listening sockets (top relevant ports) =====
    ...
    LISTEN 0      4096         0.0.0.0:3000      0.0.0.0:*    users:(("docker-proxy",pid=3514382,fd=4))               
    ...
    LISTEN 0      4096            [::]:3000         [::]:*    users:(("docker-proxy",pid=3514388,fd=4))               
  ===== 3. Docker containers + ports =====
    NAMES            IMAGE                                                   PORTS                                                  STATUS
    treatbot-api     treatbot-api:6bb2681f3f7de01e843e0165412e8b4ff36b5ecb   0.0.0.0:3000->3000/tcp, :::3000->3000/tcp              Up 5 seconds (healthy)
  ...
  ===== 10. /var/www listing =====
    ...
    drwxr-xr-x  3 ubuntu ubuntu 4096 May  2 02:27 treatbot-web
  ===== 11. Backup nginx tree (NOT removing) =====
    ✓ nginx tree → /home/ubuntu/treatbot-deploy-backups/nginx-tree.20260502-022731.tar.gz (16K)
  ===== 12. Backup current Caddyfile =====
    ✓ Caddyfile → /home/ubuntu/treatbot-deploy-backups/Caddyfile.20260502-022731
::group::C.5) Apply new Caddyfile + retire nginx
  ✓ New Caddyfile uploaded (114 lines)
  ✓ Current Caddyfile backed up to /home/ubuntu/treatbot-deploy-backups/Caddyfile.before-swap.20260502-022731
  --- diff (current → new) ---
  --- end diff ---
  --- validate (rc=0) ---
    {"level":"info","ts":1777660070.9928005,"msg":"using config from file","file":"/tmp/deploy/Caddyfile"}
    {"level":"warn","ts":1777660070.9940116,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.9940257,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.9942951,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.9943073,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.994382,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.994392,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.9945123,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-For: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"warn","ts":1777660070.9945242,"logger":"caddyfile","msg":"Unnecessary header_up X-Forwarded-Proto: the reverse proxy's default behavior is to pass headers to the upstream"}
    {"level":"info","ts":1777660070.9983068,"msg":"adapted config to JSON","adapter":"caddyfile"}
    {"level":"warn","ts":1777660070.9985137,"msg":"Caddyfile input is not formatted; run 'caddy fmt --overwrite' to fix inconsistencies","adapter":"caddyfile","file":"/tmp/deploy/Caddyfile","line":23}
    {"level":"info","ts":1777660070.999299,"logger":"tls.cache.maintenance","msg":"started background certificate maintenance","cache":"0xc0007ce600"}
    {"level":"info","ts":1777660070.9995432,"logger":"http.auto_https","msg":"skipping automatic certificate management because one or more matching certificates are already loaded","domain":"inseq.top","server_name":"srv0"}
    {"level":"info","ts":1777660070.999558,"logger":"http.auto_https","msg":"skipping automatic certificate management because one or more matching certificates are already loaded","domain":"www.inseq.top","server_name":"srv0"}
    {"level":"info","ts":1777660070.999561,"logger":"http.auto_https","msg":"enabling automatic HTTP->HTTPS redirects","server_name":"srv0"}
    {"level":"info","ts":1777660071.0008466,"logger":"tls.cache.maintenance","msg":"stopped background certificate maintenance","cache":"0xc0007ce600"}
    Valid configuration
  --- end validate ---
...
unknown enabled=disabled
unknown
  ✓ nginx tree archived → /home/ubuntu/treatbot-deploy-backups/nginx-tree.retired.20260502-022731.tar.gz
  ✓ nginx already disabled
::endgroup::
::group::D) Smoke tests
  /health (container):
{"status":"ok","timestamp":"2026-05-01T18:27:54.105Z","version":"1.0.0","environment":"production"}
  / (via nginx):
    HTTP 200
